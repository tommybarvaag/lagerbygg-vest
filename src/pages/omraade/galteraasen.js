      ...
      >
        <VStack p={8} maxWidth="2xl" alignItems="flex-start">
          ...
          <Text>
            ...
            leietaker / kjøpers behov.
          </Text>
          <Text>
            Bygget deles inn i egne seksjoner på ca. BTA ca. 120 kvm. (6×20 mtr.) Hver seksjon er
            innenfor aksesystemet på 120, 240, 360 kvm. osv. det er mesanin på 60 M2 som ekstra
            etasje per seksjon. Det kan kjøpes og sammenslås flere seksjoner om ønskelig. Se vedlagt
            tegning som viser inndeling av seksjoner.
          </Text>
          <Text>
            Innvendig høyder til takplater er ca. 7 meter. Bygget er isolert, men eventuell
          ...
          <Text>
            Hver seksjon har elektrisk leddheisport (BXH 4X4,3) med 1 rad med vinduer og med GSM
            styrt port åpner. Det leveres rør-opplegg til vann og toalett i hver seksjon, og
            stoppekran i felles teknisk rom. Sanitærutstyr og vannmåler er tilvalg.
          </Text>
          <Text>
            ...
            abonnement. Det leveres også trekkerør til fiber. Det leveres utvendig belysning, ferdig
            opparbeidet asfaltert foran hver seksjon.
          </Text>
          <HeadingWithUnderscore heading="Parkering" />
          <Text>
            Det vil bli opparbeidet 3 p-plasser på fellesarealet der bruk fastsettes av sameiet iht.
            vedtekter. For kortere opphold, av/pålessing kan det parkeres foran egen port.
          </Text>
          <HeadingWithUnderscore heading="Beliggenhet" />
          <Text>
            Galteråsen Næringspark er et relativt nyetablert industriområde. Her finner man mange
            ulike aktører innen lager, logistikk og produksjon. Eiendommen har en meget sentral
            beliggenhet i Knarvik, med god adkomst og kort avstand til sentral næringsområder i
            Bergen, Åsane, Mongstad og Arna
          </Text>
          ...
          <Text>
            Som eier av egne lokaler disponerer du til enhver tid lokalene, og bestemmer selv
            hvordan innredning og planløsning skal være. Alle utgifter er forutsigbare, og du tar
            selv del i antatt verdistigning. Med dages rentenivå og generell mangel på mindre
            seksjoner i leiemarkedet, er dette en unik mulighet å sikre seg egen eiendom i det
            populære og voksende næringsområdet.
          </Text>
          <Text>
        ...
        <Carousel
          ...
          images={[
            "/images/galteraasen-2D-floor-plan-1-story.jpg",
            "/images/galteraasen-2D-floor-plan-2-story.jpg",
            "/images/storage-illustration.jpg"
          ]}
        />
      </Flex>
      <ContactUs />
