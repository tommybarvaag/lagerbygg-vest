    ...
    <>
      ...
      <Flex maxW="7xl" flexDirection="column" justifyContent="center" alignItems="center" margin="0 auto">
        <VStack p={8} maxWidth="2xl" alignItems="flex-start">
          ...
          <Text>
            Helland Gruppen Næringsbygg AS har gleden av å tilby 16 næringsseksjoner som kommer til salgs på Olsvollstranda Næringspark i Alver. Bygningene er
            under planlegging og kan tilpasses leietaker / kjøpers behov.
          </Text>
          <Text>
            Det er tiltenkt at lagerseksjonene skal kunne eies av både næringskunder og privatpersoner og kunne brukes til lager/garasje av f.eks. bobil,
            campingvogn, scooter, maskiner, varer og annet utstyr
          </Text>
          <Text>
            Bygget deles inn i egne seksjoner på ca. BTA ca. 72kvm. (6×12 mtr.) Hver seksjon er innenfor aksesystemet på 72, 144, 216 kvm. osv. Det kan kjøpes
            og sammenslås flere seksjoner om ønskelig.
          </Text>
          <Text>Innvendig høyder til takplater er ca. 6 meter. Bygget er isolert, men eventuell oppvarmingsløsning kan bestilles som tilvalg.</Text>
          <Text>
          ...
          <Text>
            Hver seksjon har elektrisk leddheisport (BXH 4X4,3) med 1 rad med vinduer og integrert gangdør med GSM styrt port åpner. Det leveres rør-opplegg til
            vann og toalett i hver seksjon, og stoppekran i felles teknisk rom. Sanitærutstyr og vannmåler er tilvalg.
          </Text>
          <Text>
            ...
            seksjon. Som blir på et eget abonnement. Det leveres også trekkerør til fiber. Det leveres utvendig belysning, 3 ferdig opparbeidet asfaltert
            parkering foran hver seksjon, samt 8 meter ut fra bygning.
          </Text>
          <Text>
          ...
          <Text>
            Det vil bli opparbeidet 2 p-plasser på fellesarealet der bruk fastsettes av sameiet iht. vedtekter. For kortere opphold, av/pålessing kan det
